...
Sử dụng mô hình Logistic Regression, XGBoost & 8 biến Beneish M-Score
...
def train_model(data, model_type="Logistic Regression", test_size=0.20, random_state=42, n_estimators=100, max_depth=3, learning_rate=0.1):
    """Huấn luyện mô hình Pipeline: StandardScaler + LogisticRegression hoặc XGBoost"""
    X = data[FEATURES]
    y = data[TARGET]
...
st.markdown(f'<div class="sub-header">Ứng dụng Học máy ({model_choice}) kết hợp 8 chỉ số Beneish M-Score giúp phát hiện sớm rủi ro thao túng BCTC</div>', unsafe_allow_html=True)
...
with tab5:
    ...
    Mô hình **Beneish M-Score** được Giáo sư Messod Beneish phát triển vào năm 1999. 
...
<div style="text-align: center; color: #94A3B8; font-size: 0.88rem;">
    ⚖️ <b>Hệ thống Dự báo Gian lận Báo cáo Tài chính</b> | Xây dựng trên nền tảng Streamlit, Scikit-Learn & XGBoost.<br>
